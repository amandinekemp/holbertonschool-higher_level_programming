...
```python
amandine@ubuntu:~/$ ./0-positive_or_negative.py 
-4 is negative
amandine@ubuntu:~/$ ./0-positive_or_negative.py 
0 is zero
amandine@ubuntu:~/$ ./0-positive_or_negative.py 
...
```python
amandine@ubuntu:~/$ ./1-last_digit.py
...
```python
amandine@ubuntu:~/$ ./2-print_alphabet.py
abcdefghijklmnopqrstuvwxyzamandine@ubuntu:~/$
```
</details>
...
```python
amandine@ubuntu:~/$ ./3-print_alphabt.py
abcdfghijklmnoprstuvwxyzamandine@ubuntu:~/$
```
</details>
...
```python
amandine@ubuntu:~/$ ./4-print_hexa.py
0 = 0x0
1 = 0x1
2 = 0x2
3 = 0x3
...
```python
amandine@ubuntu:~/$ ./5-print_comb2.py
...
```python
amandine@ubuntu:~/$ ./6-print_comb3.py
...
amandine@ubuntu:~/$ ./12-main.py | cat -e
